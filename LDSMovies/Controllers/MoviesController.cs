...
namespace LDSMovies.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString, string movieReleaseDate, string sortOrder)
        {
           ...
           var dates = from m in _context.Movie
                         select m;
            
            if (!String.IsNullOrEmpty(sortOrder))
            {
                dates = dates.OrderByDescending(s => s.ReleaseDate); ;
            }
